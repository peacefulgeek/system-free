...
export const products: Product[] = [
  ...
  { name: "Omron Platinum Blood Pressure Monitor", asin: "B07L1CDQF4", category: "devices", tags: ["blood pressure", "heart", "monitor", "cardiovascular", "home testing"], sentence: "A tool that often helps with home monitoring is the Omron Platinum Blood Pressure Monitor, clinical-grade accuracy without the copay" },
  { name: "Keto-Mojo GK+ Blood Glucose & Ketone Meter", asin: "B09JYVQKZN", category: "devices", tags: ["glucose", "ketone", "metabolic", "blood sugar", "diabetes", "keto"], sentence: "Something worth considering might be the Keto-Mojo meter for lab-quality glucose and ketone readings at home" },
  { name: "Pulse Oximeter Zacurate Pro Series", asin: "B00B8NKZ1E", category: "devices", tags: ["oxygen", "pulse", "respiratory", "monitor", "home testing"], sentence: "For those looking for a simple solution, the Zacurate Pulse Oximeter gives you a reading that would cost hundreds in an ER" },
  ...
  { name: "Theragun Mini", asin: "B09CC2RLQB", category: "devices", tags: ["massage", "muscle", "recovery", "pain", "tension", "therapy"], sentence: "A tool that often helps with muscle tension is the Theragun Mini percussion massager" },
  ...
  { name: "Thorne Vitamin D/K2 Liquid", asin: "B0797BHKR3", category: "supplements", tags: ["vitamin d", "bone", "immune", "deficiency", "sunshine"], sentence: "A tool that often helps with vitamin D deficiency is Thorne D/K2 Liquid, the gold standard in supplementation" },
  { name: "Garden of Life Probiotics", asin: "B010OSFLT0", category: "supplements", tags: ["probiotics", "gut health", "digestion", "immune", "microbiome"], sentence: "Something worth considering might be Garden of Life Probiotics for gut health support" },
  ...
  { name: "NOW Supplements Berberine", asin: "B00MR8SIG2", category: "supplements", tags: ["berberine", "blood sugar", "metabolic", "glucose", "insulin"], sentence: "A popular choice for metabolic support is NOW Berberine, which research shows can rival metformin for blood sugar" },
  ...
  { name: "Nutricost Ashwagandha", asin: "B01HFASVTK", category: "supplements", tags: ["ashwagandha", "stress", "cortisol", "adaptogen", "anxiety"], sentence: "You could also try Nutricost Ashwagandha, one of the most studied adaptogens for stress" },
  ...
  { name: "Host Defense Lion's Mane", asin: "B0BXF5K7NQ", category: "supplements", tags: ["lions mane", "brain", "cognitive", "mushroom", "memory", "focus"], sentence: "For those interested in cognitive support, Host Defense Lion's Mane is backed by solid research" },
  ...
  { name: "Yoga Mat by Manduka PRO", asin: "B0002TZ3DW", category: "journals", tags: ["yoga", "exercise", "movement", "flexibility", "home practice"], sentence: "A popular choice for home practice is the Manduka PRO yoga mat, built to last decades" },
  ...
  { name: "Berkey Water Filter System", asin: "B00BWIWZ7K", category: "home-health", tags: ["water filter", "clean water", "home", "purification", "drinking"], sentence: "A popular choice for clean drinking water is the Berkey filter system" },
  ...
  { name: "Foam Roller by LuxFit", asin: "B00KADN2AG", category: "exercise", tags: ["foam roller", "recovery", "muscle", "flexibility", "myofascial"], sentence: "Something worth considering might be the LuxFit foam roller for muscle recovery" },
